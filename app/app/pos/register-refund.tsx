...
export function RegisterRefund({ businessName }: { businessName: string }) {
  ...
  return (
    <>
      <button type="button" onClick={openModal} className="flex h-10 items-center gap-2 rounded-lg border border-border px-3.5 text-sm font-semibold hover:bg-accent">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="M3 12a9 9 0 1 0 3-6.7" /><path d="M3 4v5h5" /></svg>
        Refund
      </button>
