...
export default async function CatalogPage() {
  ...
  const { data: itemsData } = await supabase
    .from("catalog_items")
    .select("id, name, price, category, is_active, taxable, tax_rate_id, barcode, image_url, out_of_stock, out_of_stock_at, allergens, prep_minutes, default_course_id, station_id, sales_category, short_name, description, open_price, requires_manager_approval, allow_returns, print_separate_ticket")
