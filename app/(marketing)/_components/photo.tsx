...
// THE PHOTOGRAPHY REGISTRY — the eight supplied photographs, and the rules
...
// `public/images/surge/`, from the handoff's `images/` folder. Nothing here
// ever points at a Downloads path — the files live in `public/` and are served
// by the app.
//
// WEBP ORIGINALS, NOT THE HANDOFF'S JPGs. Both encodings of these eight exist
// and are pixel-for-pixel the same photographs at the same dimensions; the
// WebP set is a third of the bytes and is the one already on main. Shipping the
// JPGs alongside would have put 4MB of duplicate originals in the repository to
// produce identical derivatives, since next/image re-encodes either source the
// same way.
//
