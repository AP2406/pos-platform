...
export default function GuidePage() {
  return (
    ...
    >
      ...
      <GuideP>List every fixed fee, total them for the year, and take that number to your processor: ask for each to be removed and get the answer in writing. If they won&rsquo;t, that annual total is exactly what switching is worth. Surge&rsquo;s pricing is one flat rate with a one-time $10 setup and <strong>no monthly fee</strong> &mdash; see <Link href="/pricing" className="font-semibold text-blue-600 hover:text-blue-700">pricing</Link>, or learn to <Link href="/guides/how-to-read-your-merchant-statement" className="font-semibold text-blue-600 hover:text-blue-700">read your statement</Link>.</GuideP>
    </GuideArticle>
  );
}
