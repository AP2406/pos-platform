...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: MetadataRoute.Sitemap = [
    ...
    { url: SITE_URL + "/clover-alternative", lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: SITE_URL + "/stripe-alternative", lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: SITE_URL + "/td-merchant-solutions-alternative", lastModified: now, changeFrequency: "monthly", priority: 0.8 },
